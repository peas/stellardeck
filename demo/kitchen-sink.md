...
![inline](../assets/brand/stellardeck-simplified-min-512.png)
...
^ Steps wraps each paragraph in a fragment. Each appears one at a time on click/arrow, like build-lists but for paragraphs.
...
![](images/stellardeck-first-talk-startse.jpg)
