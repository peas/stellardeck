...
![h:250](https://picsum.photos/seed/marp/400/250)
...
![w:100px h:100px](https://picsum.photos/seed/marp/400/250) ![w:100 h:100 blur sepia:50%](https://picsum.photos/seed/marp/400/250)
...
```markdown
![bg opacity](https://picsum.photos/seed/gradient/1280/720)
```
...
```markdown
![bg blur:3px](https://picsum.photos/seed/slideA/800/600)
![bg blur:3px](https://picsum.photos/seed/slideB/800/600)
![bg blur:3px](https://picsum.photos/seed/slideC/800/600)
```
...
```markdown
![bg right](https://picsum.photos/seed/split/800/600)
```
...
##### ![w:1em h:1em](https://picsum.photos/seed/marp/400/250)  Marp: Markdown presentation ecosystem — https://marp.app/
